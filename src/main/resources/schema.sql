...
CREATE TABLE BILLING_DECEMBER_2018(
...
ALTER TABLE BILLING_DECEMBER_2018 ADD FOREIGN KEY (USER_ID) REFERENCES USER(USER_ID);
ALTER TABLE BILLING_DECEMBER_2018 ADD FOREIGN KEY (PARTNER_ID) REFERENCES PARTNER(PARTNER_ID);
CREATE INDEX IDX_START_DATE_ ON BILLING_DECEMBER_2018(BILLING_DATE);
